                ...
                <div class="p-5">
                  ...
                  <form class="user" action="/home" method="get">
                    <div class="form-group">
                      <!-- <input type="email" class="dropdown no-arrow form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Department Code"> -->
                      <div class="input-group mb-3">
                        ...
                        <select class="custom-select" id="inputGroupSelect01">
                          ...
                          <option value="IT Department">{{$department->name}}</option>
                          <!-- <option value="HR Department">HR Dept.</option>
                          <option value="Accounting Department">Accounting Dept.</option> -->
                          @endforeach
                        </select>
                      </div>
                    </div>
                    ...
                    <!-- <a href="/dashboard" class="btn btn-user btn-block btn-primary">
                      Login
                    </a> -->
