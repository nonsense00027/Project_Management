      ...
      <li class="nav-item">
        <!-- <a class="nav-link" href="index.html"> -->
          ...
          <div class="text-center">
            <span class="text-gray-100"><b>IT Deptartment</b></span>
          </div>
          <!-- </a> -->
      </li>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small btn-success" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn bg-danger text-gray-100" href="/">Logout</a>
        </div>
      </div>
    </div>
  </div>
